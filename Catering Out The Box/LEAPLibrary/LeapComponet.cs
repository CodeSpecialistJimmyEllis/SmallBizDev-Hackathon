...
namespace LeapLibrary
{
    ...
    public class LeapComponet : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        Vector2[] fingerarray;
        public List<Vector2> FingerPoints { get { return fingerPoints.ToList<Vector2>(); } }
       ...
       public  FingerList  fingers;
        ...
        public Vector2[] Fingerarray
        {
            get
            {
                if (fingerarray.Length != 0)
                    return fingerarray;
                else
                    return null;
            }
