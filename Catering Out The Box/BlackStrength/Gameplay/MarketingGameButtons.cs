...
{
   public class LeapMotionButtonsMarketing
    {
        ...
        public LeapMotionButtonsMarketing()
        {
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            buttons[0] = Content.Load<Texture2D>("ResumeGamePlayState/buttonfolder/A");
            buttons[1] = Content.Load<Texture2D>("ResumeGamePlayState/buttonfolder/B");
            buttons[2] = Content.Load<Texture2D>("ResumeGamePlayState/buttonfolder/X");
            buttons[3] = Content.Load<Texture2D>("ResumeGamePlayState/buttonfolder/Y");

            // leap component fingertips
            fingerTexture = Content.Load<Texture2D>("leap/finger");
