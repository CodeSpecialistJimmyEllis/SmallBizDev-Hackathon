...
namespace CateringOutTheBox
{
    ...
    public class ResumeVideoGame : GameScreen
    {
        ...
        LeapMotionButtonsMarketing leapMotionButtons;
        ...
        */
        ...
        public override void LoadContent(ContentManager Content)
        {
            ...
            */
            ...
            deepestmasterofcode = Content.Load<Song>("StoryTell/sound/bgmusic01");
       ...
       /*     else if (((scorenumber == 3) || (scorenumber > 3)) && (state == 1))
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(villianprojectile, villianprojecticerect, Color.Blue);
