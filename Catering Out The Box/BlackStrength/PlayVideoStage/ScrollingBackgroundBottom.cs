...
{
    class ScrollingBackgroundBottomPV
    {
        ...
        public ScrollingBackgroundBottomPV()
        {
            scrollingSpeed = 1;
        }
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            scrollingOne = Content.Load<Texture2D>("PlayVideoStage/backgrounds/scrolling/scrolling1a");
            scrollingTwo = Content.Load<Texture2D>("PlayVideoStage/backgrounds/scrolling/scrolling2a");
