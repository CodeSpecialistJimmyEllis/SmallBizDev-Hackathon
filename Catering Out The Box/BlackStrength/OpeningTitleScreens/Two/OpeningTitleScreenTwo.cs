...
namespace BlackStrength
{
    class OpeningTitleScreenTwo : GameScreen
    {
        ...
        // top moving forward
        ScrollingBackgroundTwo forward;

      
        ScrollingBackgroundBackwardsThree backwards;
        ...
        public OpeningTitleScreenTwo(bool choice)
        {
            ...
            backwards = new ScrollingBackgroundBackwardsThree();
            ...
            forward = new ScrollingBackgroundTwo();
        ...
        public override void LoadContent(ContentManager Content)
        {
            ...
            background = Content.Load<Texture2D>("TitleScreenTwo/background");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            */
            ...
            if (Keyboard.GetState(PlayerIndex.One).IsKeyDown(Keys.Enter))
            {
                ...
                ScreenManager.paperrockscissorsstate = new PaperRockScissorsState();
