...
namespace BlackStrength
{
    class OpeningTitleScreenFour : GameScreen
    {
        ...
        // top moving forward
        ScrollingBackgroundFour forward;

      
        ScrollingBackgroundBackwardsFive backwards;
        ...
        public OpeningTitleScreenFour(bool choice)
        {
            ...
            backwards = new ScrollingBackgroundBackwardsFive();
            ...
            forward = new ScrollingBackgroundFour();
        ...
        public override void LoadContent(ContentManager Content)
        {
            ...
            background = Content.Load<Texture2D>("TitleScreenFour/background");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            */
            ...
            if (Keyboard.GetState(PlayerIndex.One).IsKeyDown(Keys.Enter))
            {
                ...
                ScreenManager.blockgameplay = new BlockGamePlay();
                ScreenManager.Instance.AddScreen(ScreenManager.blockgameplay);
