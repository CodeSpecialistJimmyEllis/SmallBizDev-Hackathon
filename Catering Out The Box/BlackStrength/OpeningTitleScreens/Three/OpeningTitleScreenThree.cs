...
namespace BlackStrength
{
    class OpeningTitleScreenThree : GameScreen
    {
        ...
        // top moving forward
        ScrollingBackgroundThree forward;

      
        ScrollingBackgroundBackwardsFour backwards;
        ...
        public OpeningTitleScreenThree(bool choice)
        {
            ...
            backwards = new ScrollingBackgroundBackwardsFour();
            ...
            forward = new ScrollingBackgroundThree();
        ...
        public override void LoadContent(ContentManager Content)
        {
            ...
            background = Content.Load<Texture2D>("TitleScreenThree/background");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            */
            ...
            if (Keyboard.GetState(PlayerIndex.One).IsKeyDown(Keys.Enter))
            {
                ...
                ScreenManager.versuscharacter = new VersusCharacter();
