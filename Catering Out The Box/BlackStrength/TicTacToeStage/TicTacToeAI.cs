...
*/
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if ((Keyboard.GetState(PlayerIndex.One).IsKeyDown(Keys.Z)) && ((Winner.owins == winner) || (Winner.xwins == winner) || (Winner.nowins != winner)))
            {
                ScreenManager.openingtitlescreentwo = new OpeningTitleScreenTwo();
                ScreenManager.Instance.AddScreen(ScreenManager.openingtitlescreentwo);
